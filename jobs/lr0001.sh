...
# Slurm arguments
#
#SBATCH --job-name=LRR            # Name of the job 
#SBATCH --export=ALL                # Export all environment variables
#SBATCH --output=/home/arian/Deep-Learning-August/results/resnet152_e20_batch_32_lr0001.log
...
LOG_DIR=/home/arian/Deep-Learning-August/results/lr0001
...
python main.py --gpu --workers 4 --batch 32 --epoch 20 --model resnet152 \
	--lr 0.001 --save $LOG_DIR/resnet152_e20_batch_32_lr0001.pt \
