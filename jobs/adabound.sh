...
#SBATCH --output=/home/arian/Deep-Learning-August/results/resnet152_e20_batch_32_Adabound.log
...
LOG_DIR=/home/arian/Deep-Learning-August/results/Adabound
...
python main.py --gpu --workers 4 --scheduler CosineAnnealingLR --batch 32 --epoch 20 --model resnet152 \
	--optimizer Adabound --save $LOG_DIR/resnet152_e20_batch_32_Adabound.pt \
