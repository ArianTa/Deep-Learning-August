...
#SBATCH --output=/home/arian/Deep-Learning-August/results/resnet152_e20_batch_32_vgg19.log
...
LOG_DIR=/home/arian/Deep-Learning-August/results/vgg19
...
python main.py --gpu --workers 4 --batch 32 --epoch 20 --model vgg19 \
	--save $LOG_DIR/resnet152_e20_batch_32_vgg19.pt \
