...
#SBATCH --output=/home/arian/Deep-Learning-August/results/resnet152_e20_batch_32_vgg16.log
...
LOG_DIR=/home/arian/Deep-Learning-August/results/vgg16
...
python main.py --gpu --workers 4 --batch 32 --epoch 20 --model vgg16 \
	--save $LOG_DIR/resnet152_e20_batch_32_vgg16.pt \
